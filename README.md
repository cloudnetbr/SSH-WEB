...
```
apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/cloudnetbr/SSH-WEB/123.sh)
```
</br>
...
```
apt install wget -y; bash <(wget -qO- https://raw.githubusercontent.com/cloudnetbr/SSH-WEB/sincpainel.sh)
```
...
7- Todos os nomes TECH-SSH foi trocado por EMPRESA
