...
wget https://raw.githubusercontent.com/cloudnetbr/SSH-WEB/main/ppweb/pweb > /dev/null 2>&1
chmod 777 pweb > /dev/null 2>&1
clear
[[ ! -d /bin/ppweb ]] && mkdir /bin/ppweb
cd /bin/ppweb || exit
rm *.sh ver* > /dev/null 2>&1
wget https://raw.githubusercontent.com/cloudnetbr/SSH-WEB/main/ppweb/verifatt.sh > /dev/null 2>&1
wget https://raw.githubusercontent.com/cloudnetbr/SSH-WEB/main/ppweb/verpweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/cloudnetbr/SSH-WEB/main/ppweb/verweb > /dev/null 2>&1
wget https://raw.githubusercontent.com/cloudnetbr/SSH-WEB/main/ppweb/whatsapp.sh > /dev/null 2>&1
...
wget https://www.dropbox.com/s/kem4btm3g7e61wj/gestorssh.zip > /dev/null 2>&1
...
echo ""
echo -e "TEC SSH" | figlet | boxes -d stone -p a0v0 | lolcat
echo -e "                              \033[1;31mBy @tecssh\033[1;36m" | lolcat
echo ""
chave=$(curl -sSL "https://raw.githubusercontent.com/cloudnetbr/SSH-WEB/main/ppweb/chave") &>/dev/null
...
echo -e "\033[1;33m MAIS INFORMAÇÕES \033[1;31m(\033[1;36mTELEGRAM\033[1;31m): \033[1;37m@tecssh\033[0m" | lolcat
echo ""
